...
layout = [
            ...
            [sg.Checkbox('DegradeR', font = ('Helvetica', 10, 'bold'), key = 'degrade_resolution',tooltip='Degrade resolution, for initial R to a user defined R'), sg.Text('From R:'), sg.InputText(1600, size = (6,1), key = 'degrade_from_r'), sg.Text('to R:'), sg.InputText(600, size = (6,1), key = 'degrade_to_r')],
            [sg.Checkbox('DegradeL', font = ('Helvetica', 10, 'bold'), key='degrade_resolution_lambda',tooltip='Degrade resolution, from an initial wavelength FWHM to a user defined wavelength FWHM, in Angstrom'), sg.Text('from (FWHM, A):'), sg.InputText(2.51, size = (4,1), key = 'degrade_from_l'), sg.Text('to:'), sg.InputText(8.5, size = (4,1), key = 'degrade_to_l')     ],
            [sg.Checkbox('Normalize to:', font = ('Helvetica', 10, 'bold'), key = 'norm_spec',tooltip='Normalize the flux to a user defined wavelength'), sg.InputText(500, size = (5,1), key = 'norm_wave'), sg.Text('nm') , sg.Checkbox('Cont. sub.', font = ('Helvetica', 10, 'bold'), key = 'cont_sub',tooltip='Perform a rough continuum subtraction of the spectrum')],
            [sg.Checkbox('Sigma broadening', font = ('Helvetica', 10, 'bold'), key = 'broadening_spec',tooltip='Broad the spectra by adding a user defined sigma (km/s)'), sg.Text('Add sigma (km/s): ', font = ('Helvetica', 10)), sg.InputText(0, size = (4,1), key = 'sigma_to_add')],
            [sg.Checkbox('Add noise', font = ('Helvetica', 10, 'bold'), key = 'add_noise',tooltip='Adding poissonian noise to the spectrum'), sg.Text('SNR:'), sg.InputText(10, size = (3,1), key = 'noise_to_add'), sg.Checkbox('Mov avg', font = ('Helvetica', 10, 'bold'), key = 'moving_avg',tooltip='Moving average with a user defined box window, in pixel'), sg.Text('pix:'), sg.InputText(11, size = (3,1), key = 'avg_window')],
    ...
    #return sg.Window('SPAN - SPectral ANalysis - 4.7 --- Daniele Gasparri ---', layout,finalize=True, scaling = scale_win)
