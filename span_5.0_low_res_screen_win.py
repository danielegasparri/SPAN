...
layout = [
            ...
            [sg.Button('Create spectra list', size = (14,1), font = ('Helvetica', 9), key = 'listfile',tooltip='If you do not have a spectra file list, you can generate here'), sg.Push(), sg.Checkbox('I have just one spectrum', font = ('Helvetica', 10, 'bold'), key='one_spec',tooltip='Check this if you want to load just one spectrum instead a text file containing the names of the spectra')],
            ...
            [sg.Checkbox('Add constant', font = ('Helvetica', 9, 'bold'), key = 'add_pedestal',tooltip='Simply add a constant value to the spectrum'), sg.InputText(0, size = (7,1), key = 'pedestal_to_add'), sg.Checkbox('Multiply by:', font = ('Helvetica', 9, 'bold'), key = 'multiply',tooltip='Multiply the spectrum by a constant'), sg.InputText(1 , size = (7,1), key = 'multiply_factor')],
            [sg.Checkbox('Calculate first and second derivatives', default = False, key = 'derivatives', font = ('Helvetica', 9, 'bold'),tooltip='Calculate the derivative of the spectra')],
