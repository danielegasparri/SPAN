...
######################################################################################
#Version histories
#version 5.0 (20240221): rearranged the spectra ptre-processing frame by adding the crop and wavelet cleaning tasks and adding the parameters buttons to sigma clip cleaning (now dynamic cleaning), dopcor and heliocor. Fized a bug in the "Compare with" task. Added the continuum modelling task. Now you can model and subtract (or divide) the continuum of the spectra in a way better way.
...
layout = [
            [sg.Menu([
                ['&File', ['&Load spectra', '&Save parameters...', 'Load parameters...', 'Restore default parameters', 'E&xit']], 
                ['&Edit', ['&Copy', '&Paste', 'Clear all tas&ks', 'Clean output']], 
                ['&Help', ['&Quick start', '&Read me']], 
                ['P&rocess',['Pl&ot', 'Pre&view spec.']], 
                ['&Analysis', ['Preview res&ult', 'Proc&ess selected', 'Process a&ll']], 
                ['&Window', ['Text editor', 'FITS header editor', 'Plot data', '2D spec extraction']], 
                ['EW sigma correction', ['Compu&te!', 'Corre&ct!']], 
