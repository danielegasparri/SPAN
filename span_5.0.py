...
# version 2.95 (20220128): added the calculation of the EW in magnitude for the absurde way to measure some indices in magnitude for no sense at all!
...
#version 2.0 (20210630): Added 'compare spectra' utility, improved the sigma clipping, now called clean task, rearranged the tasks in the pre-processing and processing frames, improved the plot for the velocity dispersion measurements and put a check on the existence of the spectra loaded.
